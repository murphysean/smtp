...
var emailFromRegExp = regexp.MustCompile(`(?i)(?:^| )FROM:[^<=]*<((\S+)@(\S+\.\S+))>`)
var emailToRegExp = regexp.MustCompile(`(?i)(?:^| )TO:[^<=]*<((\S+)@(\S+\.\S+))>`)
